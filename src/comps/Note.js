...
function Note() {
    return (
        <div className="m-3 rounded-lg">
            <section className="text-gray-400 bg-gray-800 bg-opacity-40 body-font text-center items-center rounded-lg">
  <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col text-center items-center">
