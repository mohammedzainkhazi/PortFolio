    ...
    return (
        <section className="text-gray-600 body-font bg-[black] h-screen"> 
            <div className="container mx-auto flex px-5 pt-10 md:flex-row flex-col-reverse items-center">
                <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left md:mb-0 items-center text-center" data-aos="fade-right">
                    ...
                    <div className="flex justify-center gap-3">
                        <button onClick={()=>navigate('/select')} className="inline-flex text-white bg-blue-500 border-0 py-2 px-6 focus:outline-none hover:opacity-[1] opacity-[0.9] rounded text-lg">Get Started</button>
                        <a href="https://github.com/mohammedzainkhazi/finalYearProject" target='_blank'><button className="inline-flex text-gray-800 bg-gray-300 border-0 py-2 px-6 focus:outline-none hover:opacity-[1] opacity-[0.9] rounded text-lg">Contribute <GitHub className='ml-3' /></button>
                        </a>
                    </div>
                </div>
