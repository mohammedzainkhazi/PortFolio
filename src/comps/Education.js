...
function Education() {
    return (
    <section className="bg-gray-900 m-5 rounded-lg">
    <div className="container px-6 py-10 mx-auto">
        ...
        <div className="flex lg:flex-row flex-col justify-around items-center  w-full gap-8 mt-8 xl:mt-16">
            <div className="flex flex-col items-center p-8 transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-transparent group bg-gray-800 bg-gray-800 hover:bg-blue-600 border-gray-700 hover:border-transparent">
                ...
                <div className="flex mt-3 -mx-2 text-white">
                    CGPA - 8.02
                </div>
            </div>

            <div className="flex flex-col items-center p-8 transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-transparent group bg-gray-800 hover:bg-blue-600 border-gray-700 hover:border-transparent">
